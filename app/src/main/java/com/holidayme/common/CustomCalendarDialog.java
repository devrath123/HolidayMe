...
public class CustomCalendarDialog {
    ...
    public CustomCalendarDialog setLayout(View layout) {
        if (layout != null) {
    ...
    public CustomCalendarDialog setLayoutResourceId(int layoutResourceId) {
    ...
    public CustomCalendarDialog setLocation(int[] location) {
        this.location = location;
        return this;
    }


    public CustomCalendarDialog setLocationByAttachedView(View attachedView) {
    ...
    public CustomCalendarDialog setGravity(int gravity) {
    ...
    public CustomCalendarDialog setMatchParent(boolean matchParent) {
    ...
    public CustomCalendarDialog setMarginLeftAndRight(int left, int right) {
    ...
    public CustomCalendarDialog setMarginTopAndBottom(int top, int bottom) {
        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) llContent.getLayoutParams();
    ...
    public CustomCalendarDialog setTouchOutsideDismiss(boolean touchOutsideDismiss) {
    ...
    public CustomCalendarDialog setOutsideColor(int color) {
    ...
    public CustomCalendarDialog setBackgroundColor(int color) {
    ...
    public CustomCalendarDialog show() {
        if (dialog != null) {
            if (contentView == null) {
    ...
    public CustomCalendarDialog setAnimationTranslationShow(int direction, int duration, float... values) {
        return setAnimationTranslation(true, direction, duration, values);
    }


    public CustomCalendarDialog setAnimationTranslationDismiss(int direction, int duration, float... values) {
        return setAnimationTranslation(false, direction, duration, values);
    }

    private CustomCalendarDialog setAnimationTranslation(boolean isShow, int direction, int duration, float... values) {
    ...
    public CustomCalendarDialog setAnimationAlphaShow(int duration, float... values) {
        return setAnimationAlpha(true, duration, values);
    }


    public CustomCalendarDialog setAnimationAlphaDismiss(int duration, float... values) {
        return setAnimationAlpha(false, duration, values);
    }

    private CustomCalendarDialog setAnimationAlpha(boolean isShow, int duration, float... values) {
    ...
    public CustomCalendarDialog setCancelable(boolean cancelable) {
    ...
    public CustomCalendarDialog setOnEasyDialogDismissed(OnEasyDialogDismissed onEasyDialogDismissed) {
